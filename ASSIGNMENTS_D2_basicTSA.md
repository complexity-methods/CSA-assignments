...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-5-1.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-5-2.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-5-3.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-5-4.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-1.png)<!-- -->

```r
acf(series$TS_1, lag.max = 50, type = "partial")
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-2.png)<!-- -->

```r
plotRED_acf(y = series$TS_1,Lmax = 50, returnCorFun = FALSE)
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-3.png)<!-- -->

```r
acf(series$TS_2, lag.max = 50)
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-4.png)<!-- -->

```r
acf(series$TS_2, lag.max = 50, type = "partial")
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-5.png)<!-- -->

```r
plotRED_acf(y = series$TS_2,Lmax = 50, returnCorFun = FALSE)
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-6.png)<!-- -->

```r
acf(series$TS_3, lag.max = 50)
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-7.png)<!-- -->

```r
acf(series$TS_3, lag.max = 50, type = "partial")
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-6-8.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-7-1.png)<!-- -->
...
![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-11-1.png)<!-- -->

```r
plot(dplyr::lag(series$TS_2), series$TS_2, pch = ".")
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-11-2.png)<!-- -->

```r
plot(dplyr::lag(series$TS_3), series$TS_3, pch = ".")
```

![](ASSIGNMENTS_D2_basicTSA_files/figure-html/unnamed-chunk-11-3.png)<!-- -->

...
The logistic map is a difference equation (discrete, metronome time), which is of interest as an iterative process because it is the simplest example of a process that can display deterministic chaos. 
...
This is data from an iteration of the logistic growth differential equation, but let’s pretend it’s data from one subject measured on 100 occasions.
